...
internal class RegisterAsNewPlayerHandler : ICommandHandler<RegisterAsNewPlayerCommand>
{
    ...
    public async Task<Result> HandleAsync(RegisterAsNewPlayerCommand command)
    {
        ...
        var playerResult = Player.Register(command.Email, command.Name, command.ImageUrl, _emailInUseChecker);
